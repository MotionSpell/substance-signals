...
unittest("dasher: timing computation") {
	...
	auto expectedMpd = format("<?xml version=\"1.0\"?>\n"
	        "<MPD xmlns=\"urn:mpeg:dash:schema:mpd:2011\" type=\"dynamic\" id=\"id\" profiles=\"urn:mpeg:dash:profile:isoff-live:2011, http://dashif.org/guidelines/dash264\" availabilityStartTime=\"1970-01-01T00:00:03Z\" publishTime=\"1970-01-01T00:29:49Z\" minBufferTime=\"PT00H00M0.001S\">\n"
...
unittest("dasher: multi-period folders") {
	...
	auto expectedMpd = format("<?xml version=\"1.0\"?>\n"
	        "<MPD xmlns=\"urn:mpeg:dash:schema:mpd:2011\" type=\"static\" id=\"id\" profiles=\"urn:mpeg:dash:profile:isoff-live:2011, http://dashif.org/guidelines/dash264\" availabilityStartTime=\"1970-01-01T00:00:03Z\" publishTime=\"1970-01-01T00:29:49Z\" minBufferTime=\"PT00H00M0.001S\" mediaPresentationDuration=\"PT00H00M6.000S\">\n"
	        "  <ProgramInformation moreInformationURL=\"http://signals.gpac-licensing.com\">\n"
	        "    <Copyright>Generated by Signals/%s</Copyright>\n"
	        "  </ProgramInformation>\n"
