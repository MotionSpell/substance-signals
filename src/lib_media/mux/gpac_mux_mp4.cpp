...
void GPACMuxMP4::sendOutput(bool EOS) {
	...
	auto const consideredDurationIn180k = (compatFlags & FlushFragMemory) ? timescaleToClock(curFragmentDurInTs, timeScale) : timescaleToClock(curSegmentDurInTs, timeScale);
