...
private:
	...
	void declareStreamAudio(const std::shared_ptr<const MetadataPktLibavAudio> &metadata) final;
	void declareStreamSubtitle(const std::shared_ptr<const MetadataPktLibavSubtitle> &metadata) final;
