...
function ffmpeg_build {
  ...
  lazy_download "ffmpeg.tar.gz" "http://ffmpeg.org/releases/ffmpeg-4.3.8.tar.bz2"
...
EOF
  ...
  local patchFile6=$scriptDir/patches/ffmpeg_06_binutils_shr.diff
  cat << 'EOF' > $patchFile6
